...
function tutorialFixedLesson(){
  ...
  return {pieces,examples,ends:[4,7,7,8,11]};
}
...
function startInteractiveTutorial(){
  ...
  if(!lesson.pieces||lesson.examples.length<12){showToast('Le tutoriel est momentan\u00e9ment indisponible.');return;}
